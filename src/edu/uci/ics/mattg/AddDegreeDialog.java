...
public class AddDegreeDialog extends JDialog {
	/**
	 * 
	 */
	...
	public AddDegreeDialog(JDialog parent, QueryTableModel qtm) {
		super(parent, "Add Degree");
		...
		ok = new JButton("Ok");
		ok.addActionListener(new AddDegreeActionListener(this, degreeMajor, degreeSpec, department, qtm));
		...
		cancel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				AddDegreeDialog.this.setVisible(false);
			}
		});
