...
public class AddDegreeRequirementDialog extends JDialog {
	/**
	 * 
	 */
	...
	public AddDegreeRequirementDialog(JDialog parent, QueryTableModel qtm, QueryTableModel qtm2) {
		super(parent, "Add Degree Requirement");
		...
		courses = new String[ProgramState.courseMap.size()];
		i = 0;
		...
		ok = new JButton("Ok");
		ok.addActionListener(new AddDegreeRequirementActionListener(this, degreeComboBox, dReqAmountField, courseMap.values(), qtm, qtm2));
		...
		cancel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				AddDegreeRequirementDialog.this.setVisible(false);
			}
		});
